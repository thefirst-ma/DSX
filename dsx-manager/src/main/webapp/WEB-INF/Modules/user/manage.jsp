...
<body>
    ...
    <div class="main">
        <div class="sidbar" id="sidbar">
            <div class="sub_nav">
                <h2><p class="systemIcon">菜品推荐</p></h2>
                    ...
                    <ul id="show_iframe" class="switch_nav">
						<li class="nav_current">
							<a href="#" class="subNavigation" id="A001010"
							   ...
							   data-url="${pageContext.request.contextPath}/user/info.do">菜品信息</a>
						</li>
						<li class="nav_current">
		...
		<div id="common_iframe" class="maincontent">
			<iframe class="common_iframe" id="A001010_iframe" frameborder="0" border="0" src="${pageContext.request.contextPath}/user/info1.do"></iframe>
		</div>
    </div>
    </form>
</body>
